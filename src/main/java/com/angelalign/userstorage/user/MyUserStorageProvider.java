        ...
        OnUserCache
{
    ...
    protected UserDao rbacAccountDao;

    protected ComponentModel model;
    protected KeycloakSession session;

    MyUserStorageProvider(KeycloakSession session, ComponentModel model,UserDao rbacAccountDao) {
        this.session = session;
        this.model = model;
        this.rbacAccountDao = rbacAccountDao;
    }
...
//        query.setParameter("username", username);
        UserEntity user = rbacAccountDao.getUserByUsername(username);
    ...
    public UserModel getUserByEmail(RealmModel realm, String email) {
        ...
        UserEntity user = rbacAccountDao.getUserByEmail(email);
        if (Objects.isNull(user)) {
...
//        return true;
    ...
    public int getUsersCount(RealmModel realm) {
        return rbacAccountDao.getUserCount();
    }

    @Override
    public Stream<UserModel> searchForUserStream(RealmModel realm, Map<String, String> params, Integer firstResult, Integer maxResults) {
        String search = params.get(UserModel.SEARCH);
        List<UserEntity> userList = rbacAccountDao.searchForUser(search);
